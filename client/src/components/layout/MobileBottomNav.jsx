    ...
    <>
      {showMore && (
        <div className="fixed inset-0 z-40 md:hidden" onClick={() => setShowMore(false)}>
          ...
          <div className="absolute bottom-[56px] left-2 right-2 animate-slide-up" onClick={(e) => e.stopPropagation()}>
            <div className="bg-[#1c1c1e]/95 backdrop-blur-2xl rounded-[18px] overflow-hidden shadow-2xl">
              ...
              {/* Grid */}
              <div className={`grid gap-y-4 px-4 pt-2 pb-5 ${allItems.length <= 4 ? 'grid-cols-4' : 'grid-cols-5'}`}>
                {allItems.map((item) => (
